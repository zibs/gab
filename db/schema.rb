...
ActiveRecord::Schema.define(version: 20160405181458) do
  ...
  create_table "gabs", force: :cascade do |t|
    t.text     "title"
    t.string   "uuid_url"
    t.text     "body"
    t.integer  "user_id"
  ...
  add_index "gabs", ["user_id"], name: "index_gabs_on_user_id", using: :btree
  ...
  add_index "images", ["gab_id"], name: "index_images_on_gab_id", using: :btree
  ...
  add_foreign_key "gabs", "users"
  add_foreign_key "images", "gabs"
end
